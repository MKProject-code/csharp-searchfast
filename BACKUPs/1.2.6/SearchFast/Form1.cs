...
/* CHANGELOG *
 * 
 * 1.2.6 @ 2016-2020 - poprawienie błędu nie wyświetlania znalezionego pliku oraz kilka innych mniej ważnych + dodanie kilku usprawnień oraz pomijanie błędów w przypadku braku dostępu do jakiegoś folderu.
 * 
 */
...
namespace SearchFast
{
    public partial class Form1 : Form
    {
        ...
        {
            LaunchCommandLineApp("explorer", Path.GetDirectoryName(textBoxDir.Text + "\\" + listViewResultView.SelectedItems[0].Text));
        }
    }
}
